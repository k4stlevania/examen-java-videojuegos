...
<body>
    <div class="container">
        ...
        <form:form class="form" action="/procesa/formulario/editar/${editarJuego.id}" method="POST" modelAttribute="editarJuego">
            <input type="hidden" name="_method" value="PUT">
            <div>
                <form:label path="titulo" class="form-label">Titulo:</form:label>
                <form:input path="titulo" class="form-control w-75"/>
                <form:errors path="titulo" class="form-text" class="error"/>
            </div>
            <div >
            ...
            <div>
                ...
                <form:errors path="plataforma" class="form-text" class="error"/>
            </div>
            <div>
            ...
            <div class="mb-3">
                ...
                <form:errors path="fechaLanzamiento" class="form-text" class="error"/>
            </div>
